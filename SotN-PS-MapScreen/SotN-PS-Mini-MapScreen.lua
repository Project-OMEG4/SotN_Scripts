...
function UpdateTimerAndText()
	...
	BuildAutoTimerStr()
	forms.drawText(pbLiveMap,8,530,RTATimeStr,txcolor,0xFF000000, 20)
...
function ChangeCastle()
	...
	-- Draw Castle Outline
	if(curCastle == 1) then forms.drawImage(pbLiveMap,"Images/Castle1_Empty_TP.png",0,0,320,255,true) end
	if(curCastle == 2) then forms.drawImage(pbLiveMap,"Images/Castle2_Empty_TP.png",0,0,320,255,true) end
	forms.refresh(pbLiveMap)
end
